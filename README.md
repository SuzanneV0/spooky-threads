...
- **Subscriptions**: `/subscriptions` — three tiers a logged-in user can select (no real recurring billing; sets `profiles.subscription_tier`, which the quiz gate checks). Selecting a tier or cancelling updates the account in place.
